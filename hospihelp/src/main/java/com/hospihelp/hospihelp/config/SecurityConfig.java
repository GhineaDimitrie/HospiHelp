    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/alarme/**").hasAnyRole("ADMIN", "ROBOT", "FARMACIST", "RECEPTIONIST")
                        .requestMatchers("/api/comenzi/**").hasAnyRole("ADMIN", "MEDIC", "ROBOT", "ASISTENTA", "FARMACIST", "RECEPTIONIST")
                        .requestMatchers("/api/paturi/**").hasAnyRole("ADMIN", "ROBOT", "ASISTENTA", "MEDIC", "RECEPTIONIST")
